Shader "Custom/WaterShader"
{
    Properties
    {
        ...
        [Normal] _NormalMapTex("Normal map", 2D) = "white" {}
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                {
                    fixed4 col = _Color;//fixed4 col = i.color; // TODO: replace after testing
                    ...
                    return lerp(col, groundTex, groundIntensity) * lightIntensity;
                }
                ENDCG
            }
        }
